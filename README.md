...
- Edit the source, load a prose/Markdown/LaTeX sample, or import a text file up to 2 MB.
- Add up to six independent strategies, including multiple configurations of the same method.
- Configure character, recursive, token, Markdown, or LaTeX splitting. Overlap must be nonnegative and smaller than chunk size.
